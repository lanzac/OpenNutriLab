...
# This class is used to define the choices for vitamin units with human-readable
# representations. Huan-readable representations are mandatory for the CharField
# choices of default_unit_in_form And used as well in init_nutrients.py to create
# the Vitamin model instances.
...
VITAMIN_UNIT_CHOICES = (
    VitaminUnitChoices.choices
)  # value (choice value) + label (human-readable)
