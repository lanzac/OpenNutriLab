...
from foods.off_utils import fetch_local_product_data
from foods.off_utils import fetch_product_data
from foods.schema import MacronutrientsSchema
from foods.schema import ProductFormSchema
...
def sample_data(tmp_path: Path) -> Path:
    ...
    data_dir = tmp_path / "foods" / "tests" / "data"
...
def test_fetch_product_data():
    ...
    with patch("foods.off_utils.requests.get", return_value=mock_response):
